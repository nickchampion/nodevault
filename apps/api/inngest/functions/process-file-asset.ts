...
import { supportedContentTypeSchema } from '@platform/components.nodevault.contracts'
import type { SupportedContentType } from '@platform/components.nodevault.contracts'
